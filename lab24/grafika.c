    ...
    case WM_PAINT:
        {
            ...
            HBRUSH hbrush;
            hbrush = CreateSolidBrush(RGB(140, 0, 0));
            ...
            SelectObject(hdc, hbrush);
            Ellipse(hdc, 75, 235, 125, 285);
            hbrush = CreateHatchBrush(HS_HORIZONTAL, RGB(60, 70, 0));
            SelectObject(hdc, hbrush);
            Ellipse(hdc, 225, 235, 275, 285);
            
            hpen = CreatePen(PS_SOLID, 0, RGB(0, 0, 0));
            SelectObject(hdc, hpen);
            hbrush = CreateSolidBrush(RGB(0, 0, 0));
            SelectObject(hdc, hbrush);
            Ellipse(hdc, 500, 235, 580, 315);
